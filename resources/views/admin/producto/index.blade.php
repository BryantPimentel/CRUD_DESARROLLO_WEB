                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'id_marca'">{{ trans('admin.producto.columns.id_marca') }}</th>
                                        <th is='sortable' :column="'precio_costo'">{{ trans('admin.producto.columns.precio_costo') }}</th>
                                        <th is='sortable' :column="'precio_venta'">{{ trans('admin.producto.columns.precio_venta') }}</th>
