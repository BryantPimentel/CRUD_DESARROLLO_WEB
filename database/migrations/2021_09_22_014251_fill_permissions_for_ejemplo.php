...
class FillPermissionsForEjemplo extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForEjemplo constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.ejemplo',
            'admin.ejemplo.index',
            'admin.ejemplo.create',
            'admin.ejemplo.show',
            'admin.ejemplo.edit',
            'admin.ejemplo.delete',
            'admin.ejemplo.bulk-delete',
        ]);
