...
/** @var  \Illuminate\Database\Eloquent\Factory $factory */
$factory->define(App\Models\Ejemplo::class, static function (Faker\Generator $faker) {
    return [
...
$factory->define(App\Models\Producto::class, static function (Faker\Generator $faker) {
    return [
        ...
        'id_marca' => $faker->randomNumber(5),
        'descripcion' => $faker->text(),
        'precio_costo' => $faker->randomNumber(5),
        'precio_venta' => $faker->randomNumber(5),
...
/** @var  \Illuminate\Database\Eloquent\Factory $factory */
$factory->define(App\Models\Marca::class, static function (Faker\Generator $faker) {
    return [
